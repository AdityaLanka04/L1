...
async def generate_questions(
    ...
    try:
        ...
        if not topic and not chat_session_ids and not slide_ids:
            raise HTTPException(status_code=400, detail="Please provide a topic or select chat sessions/slides")
        
        source_content = ""
        
        if topic:
            source_content = f"Generate questions on the topic: {topic}\n\n"
