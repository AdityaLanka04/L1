...
class StudentKnowledgeState(Base):
    """BKT (Bayesian Knowledge Tracing) state per student × concept."""
...
class StudentMemory(Base):
    """Semantic memory entries stored per student interaction."""
...
class MessageMLLog(Base):
    """Per-message ML pipeline telemetry log."""
...
class AgentEvent(Base):
    """Cross-feature event log consumed by CentralContextAgent."""
